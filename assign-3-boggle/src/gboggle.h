...
/**
 * Constants: kBoggleWindowWidth, kBoggleWindowHeight
 * --------------------------------------------------
 * Defines the width and height of the Boggle window in all cases.
 */
...
/*
 * Function: shutdownGBoggle
 * Usage: shutdownGBoggle();
 * -----------------------
 * Closes the graphics window and frees the resources associated with
 * the GBoggle package.
 */
...
void recordWordForPlayer(const std::string& word, Player player);
